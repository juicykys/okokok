...
# DB
connect = sqlite3.connect("opik3.db")
...
#############################################ДОНАТ###################
@dp.message_handler(lambda message: message.text.lower() == 'донат')
async def process_command_1(message: types.Message):

           button1 = InlineKeyboardButton('Плюшки🍥', callback_data = '77')
           buttons = InlineKeyboardMarkup().add(button1)
           photo = open('1621821250_15-phonoteka_org-p-fon-dlya-stranitsi-otpravki-donata-15.jpg', 'rb')           
           await bot.send_photo(message.chat.id, photo,  f'Вот меню доната💎:\nДонат валюта🍥\nЧтобы узнать про плюшки доната🕌 перейдите по кнопке которая снизу👇', reply_markup= buttons)         
                   	    	
@dp.callback_query_handler(lambda c: c.data == '77')
async def process_callback_yes(callback: types.CallbackQuery):
	
	await callback.message.answer("<code>Валюта💰</code>\n<code>Голд🌟</code>\n<code>Премиум💎</code>\n<code>Админ🕌</code>\n\n\n<code>🛒 | За донатом обращайтесь к разработчикy - @juicykys</code>", parse_mode='html')
...
{name}, <code>информация о игроке:</code>
...
''', parse_mode='html')
        ...
        await bot.send_message(message.chat.id, f'{name}, <code>доступ к данной команде ограничен📛, для покупки администратора обратитесь к создателю бота 👨‍💻</code>', parse_mode='html')
...
async def check_bot(message): 
    await message.reply('✅ <code>да здесь Я, клоун!</code>')             
#Репутация
    ...
    if status_block == 'off':
            ...
            if int(pets) == 0:
                if pet1 == 0:
                    if int(balance) >= int(summ):
                        await bot.send_message(message.chat.id, f'🐥 | {user_name}, <code>вы успешно купили цыплёнка за 1.000.000£ 🎉</code>', parse_mode='html')
        ...
        if message.text.lower() in ["купить питомца 2", "Купить питомца 2"]:    
            ...
            if int(pets) == 0:
                if pet2 == 0:
                    if int(balance) >= int(summ):
                        await bot.send_message(message.chat.id, f'🐈 | {user_name}, <code>вы успешно купили кота за 2.000.000£ 🎉</code>', parse_mode='html')
                        cursor.execute(f'UPDATE users SET balance = {balance - summ} WHERE user_id = "{user_id}"') 
        ...
        if message.text.lower() in ["купить питомца 3", "Купить питомца 3"]:    
            ...
            if int(pets) == 0:
                if pet3 == 0:
                    if int(balance) >= int(summ):
                        await bot.send_message(message.chat.id, f'🐕 | {user_name}, <code>вы успешно купили пса за 5.000.000£ 🎉</code>', parse_mode='html')
                        cursor.execute(f'UPDATE users SET balance = {balance - summ} WHERE user_id = "{user_id}"') 
                        cursor.execute(f'UPDATE users SET pet_hp = {100} WHERE user_id = "{user_id}"') 
                        cursor.execute(f'UPDATE users SET pet_eat = {100} WHERE user_id = "{user_id}"') 
                        cursor.execute(f'UPDATE users SET pet_mood = {100} WHERE user_id = "{user_id}"') 
        ...
        if message.text.lower() in ["купить питомца 4", "Купить питомца 4"]:    
            ...
            if int(pets) == 0:
                if pet4 == 0:
                    if int(balance) >= int(summ):
                        await bot.send_message(message.chat.id, f'🦜 | {user_name}, <code>вы успешно купили попугая за 7.000.000£ 🎉</code>', parse_mode='html')
                        cursor.execute(f'UPDATE users SET balance = {balance - summ} WHERE user_id = "{user_id}"') 
        ...
        if message.text.lower() in ["купить питомца 5", "Купить питомца 5"]:    
            ...
            if int(pets) == 0:
                if pet5 == 0:
                    if int(balance) >= int(summ):
                        await bot.send_message(message.chat.id, f'🦄 | {user_name}, <code>вы успешно купили единорога за 10.000.000£ 🎉</code>', parse_mode='html')
                        cursor.execute(f'UPDATE users SET balance = {balance - summ} WHERE user_id = "{user_id}"') 
        ...
        if message.text.lower() in ["купить питомца 6", "Купить питомца 6"]:    
            ...
            if int(pets) == 0:
                if pet6 == 0:
                    if int(balance) >= int(summ):
                        await bot.send_message(message.chat.id, f'🐒 | {user_name}, <code>вы успешно купили обезьяну за 12.500.000£ 🎉</code>', parse_mode='html')
                        cursor.execute(f'UPDATE users SET balance = {balance - summ} WHERE user_id = "{user_id}"') 
        ...
        if message.text.lower() in ["купить питомца 7", "Купить питомца 7"]:    
            ...
            if int(pets) == 0:
                if pet7 == 0:
                    if int(balance) >= int(summ):
                        await bot.send_message(message.chat.id, f'🐬 | {user_name}, <code>вы успешно купили дельфина за 15.000.000£ 🎉</code>', parse_mode='html')
                        cursor.execute(f'UPDATE users SET balance = {balance - summ} WHERE user_id = "{user_id}"') 
        ...
        if message.text.lower() in ["купить питомца 8", "Купить питомца 8"]:    
            ...
            if int(pets) == 0:
                if pet8 == 0:
                    if int(balance) >= int(summ):
                        await bot.send_message(message.chat.id, f'🐅 | {user_name}, <code>вы успешно купили тигра за 20.000.000£ 🎉</code>', parse_mode='html')
                        cursor.execute(f'UPDATE users SET balance = {balance - summ} WHERE user_id = "{user_id}"') 
        ...
        if message.text.lower() in ["купить питомца 9", "Купить питомца 9"]:    
            ...
            if int(pets) == 0:
                if pet9 == 0:
                    if int(balance) >= int(summ):
                        await bot.send_message(message.chat.id, f'🐉 | {user_name}, <code>вы успешно купили дракона за 25.000.000£ 🎉</code>', parse_mode='html')
                        cursor.execute(f'UPDATE users SET balance = {balance - summ} WHERE user_id = "{user_id}"') 
        ...
        if message.text.lower() in ["мой питомец", "Мой питомец"]:        
            ...
            if pets == 0:
                await bot.send_message(message.chat.id, f'ℹ️ | {user_name}, <code>у вас нету питомца!</code> {rloser}', parse_mode='html')    
            if pet1 == 1:
                
                await message.bot.send_message(message.chat.id, f'🐥 | {user_name}, <code>ваш питомец: цыплёнок \n✏️ | Имя питомца: {pet_name}\n❤️ | ХП: {pet_hp} \n🍗 | Сытость: {pet_eat}\n☀️ | Настроение: {pet_mood} \n\n✏ | Питомец имя [имя] - изменить имя питомца\n❤ | Вылечить питомца - вылечить питомца\n🍗 | Покормить питомца - покормить питомца\n🌳 | Выгулять питомца - поднять настроение питомцу</code>', parse_mode='html')            
            if pet2 == 1:     
               
                await message.bot.send_message(message.chat.id, f'🐈 | {user_name}, <code>ваш питомец: кот \n✏️ | Имя питомца: {pet_name}\n❤️ | ХП: {pet_hp} \n🍗 | Сытость: {pet_eat}\n☀️ | Настроение: {pet_mood} \n\n✏ | Питомец имя [имя] - изменить имя питомца\n❤ | Вылечить питомца - вылечить питомца\n🍗 | Покормить питомца - покормить питомца\n🌳 | Выгулять питомца - поднять настроение питомцу</code>', parse_mode='html')                    
            if pet3 == 1:   
                
                await message.bot.send_message(message.chat.id, '🐕 | {user_name}, <code>ваш питомец: пёс \n✏️ | Имя питомца: {pet_name}\n❤️ | ХП: {pet_hp} \n🍗 | Сытость: {pet_eat}\n☀️ | Настроение: {pet_mood} \n\n✏ | Питомец имя [имя] - изменить имя питомца\n❤ | Вылечить питомца - вылечить питомца\n🍗 | Покормить питомца - покормить питомца\n🌳 | Выгулять питомца - поднять настроение питомцу</code>', parse_mode='html')                            
            if pet4 == 1:           
                
                await message.bot.send_message(message.chat.id, f'🦜 | {user_name}, <code>ваш питомец: попугай \n✏️ | Имя питомца: {pet_name}\n❤️ | ХП: {pet_hp} \n🍗 | Сытость: {pet_eat}\n☀️ | Настроение: {pet_mood} \n\n✏ | Питомец имя [имя] - изменить имя питомца\n❤ | Вылечить питомца - вылечить питомца\n🍗 | Покормить питомца - покормить питомца\n🌳 | Выгулять питомца - поднять настроение питомцу</code>', parse_mode='html')                            
            if pet5 == 1:
                
                await message.bot.send_message(message.chat.id, f'🦄 | {user_name}, <code>ваш питомец: единорог \n✏️ | Имя питомца: {pet_name}\n❤️ | ХП: {pet_hp} \n🍗 | Сытость: {pet_eat}\n☀️ | Настроение: {pet_mood} \n\n✏ | Питомец имя [имя] - изменить имя питомца\n❤ | Вылечить питомца - вылечить питомца\n🍗 | Покормить питомца - покормить питомца\n🌳 | Выгулять питомца - поднять настроение питомцу</code>', parse_mode='html')                                       
            if pet6 == 1:
                
                await message.bot.send_message(message.chat.id, f'🐒 | {user_name}, <code>ваш питомец: обезьяна \n✏️ | Имя питомца: {pet_name}\n❤️ | ХП: {pet_hp} \n🍗 | Сытость: {pet_eat}\n☀️ | Настроение: {pet_mood} \n\n✏ | Питомец имя [имя] - изменить имя питомца\n❤ | Вылечить питомца - вылечить питомца\n🍗 | Покормить питомца - покормить питомца\n🌳 | Выгулять питомца - поднять настроение питомцу</code>', parse_mode='html')                                       
            if pet7 == 1:
                
                await message.bot.send_message(message.chat.id, f'🐬 | {user_name}, <code>ваш питомец: дельфин \n✏️ | Имя питомца: {pet_name}\n❤️ | ХП: {pet_hp} \n🍗 | Сытость: {pet_eat}\n☀️ | Настроение: {pet_mood} \n\n✏ | Питомец имя [имя] - изменить имя питомца\n❤ | Вылечить питомца - вылечить питомца\n🍗 | Покормить питомца - покормить питомца\n🌳 | Выгулять питомца - поднять настроение питомцу</code>', parse_mode='html')                                       
            if pet8 == 1:
                
                await message.bot.send_message(message.chat.id, f'🐅 | {user_name}, <code>ваш питомец: тигр \n✏️ | Имя питомца: {pet_name}\n❤️ | ХП: {pet_hp} \n🍗 | Сытость: {pet_eat}\n☀️ | Настроение: {pet_mood} \n\n✏ | Питомец имя [имя] - изменить имя питомца\n❤ | Вылечить питомца - вылечить питомца\n🍗 | Покормить питомца - покормить питомца\n🌳 | Выгулять питомца - поднять настроение питомцу</code>', parse_mode='html')                                       
            if pet9 == 1: 
                
                await message.bot.send_message(message.chat.id, f'🐉 | {user_name}, <code>ваш питомец: дракон \n✏️ | Имя питомца: {pet_name}\n❤️ | ХП: {pet_hp} \n🍗 | Сытость: {pet_eat}\n☀️ | Настроение: {pet_mood} \n\n✏ | Питомец имя [имя] - изменить имя питомца\n❤ | Вылечить питомца - вылечить питомца\n🍗 | Покормить питомца - покормить питомца\n🌳 | Выгулять питомца - поднять настроение питомцу</code>', parse_mode='html')                                      
            if pet10 == 1:
                
                await message.bot.send_message(message.chat.id, f'☃️ | {user_name}, <code>ваш питомец: снеговик \n✏️ | Имя питомца: {pet_name}\n❤️ | ХП: {pet_hp} \n🍗 | Сытость: {pet_eat}\n☀️ | Настроение: {pet_mood} \n\n✏ | Питомец имя [имя] - изменить имя питомца\n❤ | Вылечить питомца - вылечить питомца\n🍗 | Покормить питомца - покормить питомца\n🌳 | Выгулять питомца - поднять настроение питомцу</code>', parse_mode='html')                                       
        ...
        if message.text.startswith("Питомец имя") or message.text.startswith("питомец имя"): 
            user_name = message.from_user.get_mention(as_html=True)
            pet1 = cursor.execute("SELECT pet1 from users where user_id = ?",(message.from_user.id,)).fetchone()
            pet1 = int(pet1[0])
            pet2 = cursor.execute("SELECT pet2 from users where user_id = ?",(message.from_user.id,)).fetchone()
        ...
        if message.text.lower() in ["продать питомца", "Продать питомца"]:
            ...
            if pets == 0:
                await bot.send_message(message.chat.id, f'ℹ️ | {user_name}, у вас нету питомца! {rloser}', parse_mode='html')
            if pet1 == 1:
                await bot.send_message(message.chat.id, f'💰 | {user_name}, вы успешно продали своего питомца за 40.000£', parse_mode='html')
                ...
                cursor.execute(f'UPDATE users SET pet_mood = {100} WHERE user_id = "{user_id}"') 
            if pet2 == 1:
                await bot.send_message(message.chat.id, f'💰 | {user_name}, вы успешно продали своего питомца за 400.000£', parse_mode='html')
                ...
                cursor.execute(f'UPDATE users SET pet_mood = {100} WHERE user_id = "{user_id}"') 
            if pet3 == 1:
                await bot.send_message(message.chat.id, f'💰 | {user_name}, вы успешно продали своего питомца за 1.000.000£', parse_mode='html')
                ...
                cursor.execute(f'UPDATE users SET pet_mood = {100} WHERE user_id = "{user_id}"') 
            if pet4 == 1:
                await bot.send_message(message.chat.id, f'💰 | {user_name}, вы успешно продали своего питомца за 2.000.000£', parse_mode='html')
                cursor.execute(f'UPDATE users SET balance = {balance + 2000000} WHERE user_id = "{user_id}"') 
                cursor.execute(f'UPDATE users SET pet4 = {pet4 - c} WHERE user_id = "{user_id}"') 
                cursor.execute(f'UPDATE users SET pet_hp = {100} WHERE user_id = "{user_id}"') 
                cursor.execute(f'UPDATE users SET pet_eat = {100} WHERE user_id = "{user_id}"') 
                cursor.execute(f'UPDATE users SET pet_mood = {100} WHERE user_id = "{user_id}"') 
            if pet5 == 1:
                await bot.send_message(message.chat.id, f'💰 | {user_name}, вы успешно продали своего питомца за 3.000.000£', parse_mode='html')
                cursor.execute(f'UPDATE users SET balance = {balance + 3000000} WHERE user_id = "{user_id}"') 
                cursor.execute(f'UPDATE users SET pet5 = {pet5 - c} WHERE user_id = "{user_id}"') 
                cursor.execute(f'UPDATE users SET pet_hp = {100} WHERE user_id = "{user_id}"') 
                cursor.execute(f'UPDATE users SET pet_eat = {100} WHERE user_id = "{user_id}"') 
                cursor.execute(f'UPDATE users SET pet_mood = {100} WHERE user_id = "{user_id}"') 
            if pet6 == 1:
                await bot.send_message(message.chat.id, f'💰 | {user_name}, вы успешно продали своего питомца за 5.000.000£', parse_mode='html')
                ...
                cursor.execute(f'UPDATE users SET pet_mood = {100} WHERE user_id = "{user_id}"')
            if pet7 == 1:
                await bot.send_message(message.chat.id, f'💰 | {user_name}, вы успешно продали своего питомца за 8.000.000£', parse_mode='html')
                cursor.execute(f'UPDATE users SET balance = {balance + 8000000} WHERE user_id = "{user_id}"') 
                cursor.execute(f'UPDATE users SET pet7 = {pet7 - c} WHERE user_id = "{user_id}"') 
                cursor.execute(f'UPDATE users SET pet_hp = {100} WHERE user_id = "{user_id}"') 
                cursor.execute(f'UPDATE users SET pet_eat = {100} WHERE user_id = "{user_id}"') 
                cursor.execute(f'UPDATE users SET pet_mood = {100} WHERE user_id = "{user_id}"') 
            if pet8 == 1:
                await bot.send_message(message.chat.id, f'💰 | {user_name}, вы успешно продали своего питомца за 10.000.000£', parse_mode='html')
                ...
                cursor.execute(f'UPDATE users SET pet_mood = {100} WHERE user_id = "{user_id}"')
            if pet9 == 1:
                await bot.send_message(message.chat.id, f'💰 | {user_name}, вы успешно продали своего питомца за 15.000.000£', parse_mode='html')
        ...
        if message.text.lower() in ["питомцы", "Питомцы"]:
            user_name = message.from_user.get_mention(as_html=True)
            chat_id = message.chat.id
            await bot.send_message(message.chat.id, f"{user_name}, <code>доступные питомцы:</code>\n🐥 <b>1. Цыплёнок - 1.000.000£</b>\n🐈 <b>2. Кот - 2.000.000£</b>\n🐕 <b>3. Пёс - 3.000.000£</b>\n🦜 <b>4. Попугай - 7.000.000£</b>\n🦄 <b>5. Единорог - 10.000.000£</b>\n🐒 <b>6. Обезьяна - 12.500.000£</b>\n🐬 <b>7. Дельфин - 15.000.000£</b>\n🐅 <b>8. Тигр - 20.000.000£</b>\n🐉 <b>9. Дракон - 25.000.000£</b>\n\n🛒 Для покупки питомца введите: Купить питомца [номер]\nℹ Для просмотра информации о своем питомце введите: Мой питомец", parse_mode='html')
                    ...
                    if summ > 0:
                        if int(pets) >= 1:
                            if pet_hp >= 20:
                                if pet_eat >= 20:
                                    if pet_mood >= 20:
                                        await bot.send_message(chat_id, f'⚔️ | {name1}, <code>вы успешно подали заявку на участие в сражениях на питомцах!\n⏳ | До начала сражения осталось 5 секунд!</code>', parse_mode='html') 
...
➤Канал🗒️ с важными новостями - @opikbotdev''',
                                       parse_mode='html')
...
{besiness2}
            ...
            await bot.send_message(message.chat.id,
                                   f"{name1},<code>ваш профиль:</code>\n🔎 | <b>ID:</b> {user_id}\n📌 | <b>Префикс:</b> {user_status2} \n💰 | <b>Баланс:</b> {balance3}£\n🔮 | [TEST]<b>Магия:</b> {magic}\n🏦 | <b>В банке:</b> {bank3}£\n🟠 | <b>Биткоины:</b> {bitkoin3}\n📈 | <b>Вакансия:</b> {work2}\n💵 | <b>Зарплата:</b> {zp}\n👑 | <b>Рейтинг:</b> {rating3}\n⚡️ | <b>Энергия:</b> {energy}\n📊 | <b>Уровень:</b> {level}\n{have2}",
                                   parse_mode='html')
...
################################################ПРОФИЛЬ#############################################################
        if message.text.lower() in ["моя машина", "Моя машина"]:
            ...
            if int(bitkoin) in range(1000000000000000000000, ):
                ...
                bitkoin3 = f'{bitkoin2} скст'
            await bot.send_message(message.chat.id, 
                                   f"{name1} <code>вот данные за ваш автомобиль 🚘\n\n[👤] | Владелец:</code> <b>{name1}\n{have2}</b>",
                                   parse_mode='html')        
...
################################################ПРОФИЛЬ#############################################################
    ...
    ''', parse_mode='html')
        ...
        if message.text.lower() == 'ограбить казну':
            ...
            rx_money = random.randint(10000, 50000)
  ...
  💭38) Отлизать👅
    ''', parse_mode='html')
        ...
        if message.text.lower() == 'ежедневный бонус':
            ...
            rx_bitcoin = random.randint(1, 2)
            rx_bitcoin2 = '{:,}'.format(rx_bitcoin)

            rx_emeralds = random.randint(1, 2)
            rx_emeralds2 = '{:,}'.format(rx_emeralds)

            rx_matter = random.randint(1, 2)
            rx_matter2 = '{:,}'.format(rx_matter)

            rx_expe = random.randint(10, 20)
        ...
        if message.text.lower() in ['Биткоин продать', 'биткоин продать', 'бтс продать', 'Бтс продать']:
            ...
            if bitkoin > 0:
                await bot.send_message(message.chat.id, f'{name}, <code>вы успешно продали {bitkoin2} BTC за {summ2}£</code> {rwin}',
                                       parse_mode='html')
                cursor.execute(f'UPDATE users SET balance = {balance + summ}  WHERE user_id = "{user_id}"')
        ...
        if message.text.startswith('биткоин купить') or message.text.startswith('бтс купить') or message.text.startswith('Бтс купить'):
            ...
            if summ <= balance:
                if bitcoin_c > 0:
                    await bot.send_message(message.chat.id,
                                           f'{name}, <code>вы успешно купили {bitcoin_c} BTC за {summ2}£</code> {rwin}',
                                           parse_mode='html')
                    cursor.execute(f'UPDATE users SET balance = {balance - summ}  WHERE user_id = "{user_id}"')
                    cursor.execute(f'UPDATE users SET bitkoin = {bitkoin + bitcoin_c}  WHERE user_id = "{user_id}"')
                    connect.commit()
...
######ЕГИПЕТ####
    ...
    {name1} , <code>вот данные о вашем банке 🏦</code>
➖➖➖➖➖➖➖➖    
➖➖➖➖➖➖➖➖
👨‍💼 <b>Владелец:</b> {user_name}
🏛  <b>Основной счёт:</b> {bank2} £
💼 <b>Хранительный счёт:</b> 0£
➖➖➖➖➖➖➖➖
🔐 <b>Деньги на депозите:</b> 0£
💎 <b>Статус депозита:</b> Обычный
📈 <b>Процент под депозит:</b> 6%
💵 <b>Деньги на вывод:</b> 0£
    ''', parse_mode='html')
        ...
        if message.text.startswith("Банк положить") or message.text.startswith("банк положить"):
            ...
            if bank_p > 0:
                if balance >= bank_p:
                    await bot.send_message(message.chat.id, f'{user_name}, <code>вы успешно положили в банк {bank2}£</code> {rwin}',
                                           parse_mode='html')
        ...
        if message.text.startswith("Банк снять") or message.text.startswith("банк снять"): 
            ...
            if bank_s > 0:
                if bank >= bank_s:
                    ...
                    photo = open('depositphotos_376214278-stock-photo-safe-deposit-box-closeup-open.jpg', 'rb')
                    await bot.send_photo(message.chat.id, photo,
            ...
            if bank_s <= 0:
                ...
                photo = open('1681389125_pictures-pibig-info-p-dulya-risunok-krasivo-1.jpg', 'rb')
                await bot.send_photo(message.chat.id, photo, f'{user_name}, нельзя снять с банка отрицательное число! {rloser}',
                                       parse_mode='html')
        ...
        if message.text.startswith("банк снять"):
            ...
            if bank_s > 0:
                if bank >= bank_s:
                    ...
                    photo = open('depositphotos_376214278-stock-photo-safe-deposit-box-closeup-open.jpg', 'rb')
                    await bot.send_photo(message.chat.id,photo,  f'{user_name}, недостаточно средств на банковском счету! {rloser}',
                                           parse_mode='html')
        ...
        if message.text.lower() == ('Выдать адм'):
            ...
            user_status = cursor.execute("SELECT user_status from users where user_id = ?",
                                         (message.from_user.id,)).fetchone()
            if user_status[0] == 'Rab':
                await bot.send_message(message.chat.id, f'<code>Вы успешно выдали администратора игроку</code> {reply_user_name} {rwin}', parse_mode='html')
                cursor.execute(f'UPDATE users SET user_status = "Admin"  WHERE user_id = "{reply_user_id}"')
                connect.commit()
            else:
                await bot.send_message(message.chat.id, f'{user_name}, <code>Доступ к данной команде ограничен. Для покупки администратора обратитесь к создателю 👨‍🦰</code>', parse_mode='html')
        if message.text.lower() == 'выдать адм' :
            user_name = message.from_user.get_mention(as_html=True)
            msg = message
            reply_user_name = message.reply_to_message.from_user.get_mention(as_html=True)
        ...
        if message.text.lower() == 'ban':
            ...
            if user_status[0] == 'Rab':
                ...
                connect.commit()
            if user_status[0] == 'Admin':
                await message.reply(f'<code>Администратор выдал бан игроку</code> {reply_user_name} ⛔️', parse_mode='html')
                cursor.execute(f'UPDATE users SET status_block = "on" WHERE user_id = "{reply_user_id}"')
                connect.commit()
            if user_status[0] == 'Player':
                await message.reply(
                    f'ℹ{user_name}, <code>Доступ к данной команде ограничен. Для покупки администратора обратитесь к создателю 👨‍🦰</code>',
                    parse_mode='html')
        ...
        if message.text.startswith("Купить дом") or message.text.startswith("купить дом"):
            ...
            if nomer == 1:
                ...
                if balance >= price:
                    if house < 1:
                        ...
                        await bot.send_message(message.chat.id, f'{name}, <code>у вас уже есть дом🏘️</code> {rloser}',
                                               parse_mode='html')
                else:
                    await bot.send_message(message.chat.id,
                                           f'{name}, <code>у вас недостаточно❌ средств💰 для покупки данного имущества</code> {rloser}',
                                           parse_mode='html')
            if nomer == 2:
                price = 1000000
                if balance >= price:
                    if house < 1:
                        await bot.send_message(message.chat.id, f'{name}, <code>вы успешно купили дом🏘️ "Подвал" 🎉</code>',
                                               parse_mode='html')
                        cursor.execute(f'UPDATE property SET have = "on"  WHERE user_id = "{user_id}"')
                        cursor.execute(f'UPDATE users SET balance = {balance - price}  WHERE user_id = "{user_id}"')
                        ...
                        await bot.send_message(message.chat.id, f'{name}, <code>у вас уже есть дом🏘</code>️ {rloser}',
                                               parse_mode='html')
                else:
                    await bot.send_message(message.chat.id,
                                           f'{name}, <code>у вас недостаточно❌ средств💰 для покупки данного имущества</code> {rloser}',
            ...
            if nomer == 3:
                ...
                if balance >= price:
                    if house < 1:
                        await bot.send_message(message.chat.id, f'{name}, <code>вы успешно купили дом🏘️ "Сарай" 🎉</code>',
                                               parse_mode='html')
                        cursor.execute(f'UPDATE property SET have = "on"  WHERE user_id = "{user_id}"')
                        cursor.execute(f'UPDATE users SET balance = {balance - price}  WHERE user_id = "{user_id}"')
            ...
            if nomer == 4:
                ...
                if balance >= price:
                    if house < 1:
                        await bot.send_message(message.chat.id, f'{name}, <code>вы успешно купили дом🏘️ "Маленький домик" 🎉</code>',
                                               parse_mode='html')
                        cursor.execute(f'UPDATE property SET have = "on"  WHERE user_id = "{user_id}"')
                        cursor.execute(f'UPDATE users SET balance = {balance - price}  WHERE user_id = "{user_id}"')
            ...
            if nomer == 5:
                ...
                if balance >= price:
                    if house < 1:
                        await bot.send_message(message.chat.id, f'{name}, <code>вы успешно купили дом🏘️ "Квартира" 🎉</code>',
                                               parse_mode='html')
                        cursor.execute(f'UPDATE property SET have = "on"  WHERE user_id = "{user_id}"')
                        cursor.execute(f'UPDATE users SET balance = {balance - price}  WHERE user_id = "{user_id}"')
            ...
            if nomer == 6:
                ...
                if balance >= price:
                    if house < 1:
                        await bot.send_message(message.chat.id, f'{name}, <code>вы успешно купили дом🏘️ "Огромный дом" 🎉</code>',
                                               parse_mode='html')
                        cursor.execute(f'UPDATE property SET have = "on"  WHERE user_id = "{user_id}"')
                        cursor.execute(f'UPDATE users SET balance = {balance - price}  WHERE user_id = "{user_id}"')
            ...
            if nomer == 7:
                ...
                if balance >= price:
                    if house < 1:
                        await bot.send_message(message.chat.id, f'{name}, <code>вы успешно купили дом🏘️ "Коттедж" 🎉</code>',
                                               parse_mode='html')
                        cursor.execute(f'UPDATE property SET have = "on"  WHERE user_id = "{user_id}"')
                        cursor.execute(f'UPDATE users SET balance = {balance - price}  WHERE user_id = "{user_id}"')
            ...
            if nomer == 8:
                ...
                if balance >= price:
                    if house < 1:
                        await bot.send_message(message.chat.id, f'{name}, <code>вы успешно купили дом🏘️ "Вилла" 🎉</code>',
                                               parse_mode='html')
                        cursor.execute(f'UPDATE property SET have = "on"  WHERE user_id = "{user_id}"')
                        cursor.execute(f'UPDATE users SET balance = {balance - price}  WHERE user_id = "{user_id}"')
            ...
            if nomer == 9:
                ...
                if balance >= price:
                    if house < 1:
                        await bot.send_message(message.chat.id, f'{name}, <code>вы успешно купили дом🏘️ "Загородный дом" 🎉</code>',
                                               parse_mode='html')
                        cursor.execute(f'UPDATE property SET have = "on"  WHERE user_id = "{user_id}"')
                        cursor.execute(f'UPDATE users SET balance = {balance - price}  WHERE user_id = "{user_id}"')
            ...
            if nomer == 10:
                ...
                if balance >= price:
                    if house < 1:
                        await bot.send_message(message.chat.id, f'{name}, <code>вы успешно купили дом🏘️ "Небоскрёб" 🎉</code>',
                                               parse_mode='html')
                        cursor.execute(f'UPDATE property SET have = "on"  WHERE user_id = "{user_id}"')
                        cursor.execute(f'UPDATE users SET balance = {balance - price}  WHERE user_id = "{user_id}"')
            ...
            if nomer == 11:
                ...
                if balance >= price:
                    if house < 1:
                        await bot.send_message(message.chat.id, f'{name}, <code>вы успешно купили дом🏘️ "Дом на мальдивах" 🎉</code>',
                                               parse_mode='html')
                        cursor.execute(f'UPDATE property SET have = "on"  WHERE user_id = "{user_id}"')
                        cursor.execute(f'UPDATE users SET balance = {balance - price}  WHERE user_id = "{user_id}"')
            ...
            if nomer == 12:
                ...
                if balance >= price:
                    if house < 1:
                        await bot.send_message(message.chat.id,
                                               f'{name}, <code>вы успешно купили дом🏘️ "Технологичный небосрёб" 🎉</code>',
                                               parse_mode='html')
                        cursor.execute(f'UPDATE property SET have = "on"  WHERE user_id = "{user_id}"')
                        cursor.execute(f'UPDATE users SET balance = {balance - price}  WHERE user_id = "{user_id}"')
            ...
            if nomer == 13:
                ...
                if balance >= price:
                    if house < 1:
                        await bot.send_message(message.chat.id,
                                               f'{name}, <code>вы успешно купили дом🏘️ "Собственный остров" 🎉</code>',
                                               parse_mode='html')
                        cursor.execute(f'UPDATE property SET have = "on"  WHERE user_id = "{user_id}"')
                        cursor.execute(f'UPDATE users SET balance = {balance - price}  WHERE user_id = "{user_id}"')
            ...
            if nomer == 14:
                ...
                if balance >= price:
                    if house < 1:
                        await bot.send_message(message.chat.id, f'{name}, <code>вы успешно купили дом🏘️ "Дом на марсе" 🎉</code>',
                                               parse_mode='html')
                        cursor.execute(f'UPDATE property SET have = "on"  WHERE user_id = "{user_id}"')
                        cursor.execute(f'UPDATE users SET balance = {balance - price}  WHERE user_id = "{user_id}"')
            ...
            if nomer == 15:
                ...
                if balance >= price:
                    if house < 1:
                        await bot.send_message(message.chat.id, f'{name}, <code>вы успешно купили дом🏘️ "Остров на марсе" 🎉</code>',
                                               parse_mode='html')
                        cursor.execute(f'UPDATE property SET have = "on"  WHERE user_id = "{user_id}"')
                        cursor.execute(f'UPDATE users SET balance = {balance - price}  WHERE user_id = "{user_id}"')
            ...
            if nomer == 16:
                ...
                if balance >= price:
                    if house < 1:
                        await bot.send_message(message.chat.id, f'{name}, <code>вы успешно купили дом🏘️ "Свой марс" 🎉</code>',
                                               parse_mode='html')
                        cursor.execute(f'UPDATE property SET have = "on"  WHERE user_id = "{user_id}"')
                        cursor.execute(f'UPDATE users SET balance = {balance - price}  WHERE user_id = "{user_id}"')
        ...
        if message.text.lower() in ['Продать дом', "продать дом"]:
            ...
            if house > 0:
                if house == 1:
                    ...
                    await bot.send_message(message.chat.id, f'{name}, <code>вы успешно продали дом🏘️ за {price3}£</code> ',
                                           parse_mode='html')
        ...
        if message.text.lower() in ['дома', 'Дома']:
            ...
            photo = open('1679333571_design-pibig-info-p-krasivie-mnogoetazhnie-doma-dizain-pintere-1.jpg', 'rb')
            await bot.send_photo(message.chat.id, photo, f'''
    {name}, <code>доступные дома:</code>
    <b>🏠 1. Коробка - 500.000£</b>
    <b>🏠 2. Подвал - 1.000.000£</b>
    <b>🏠 3. Сарай - 2.000.000£</b>
    <b>🏠 4. Маленький домик - 3.000.000£</b>
    <b>🏠 5. Квартира - 5.000.000£</b>
    <b>🏠 6. Огромный дом - 7.000.000£</b>
    <b>🏠 7. Коттедж - 10.000.000£</b>
    <b>🏠 8. Вилла - 15.000.000£</b>
    <b>🏠 9. Загородный дом - 25.000.000£</b>
    <b>🏠 10. Небоскрёб - 35.000.000£</b>
    <b>🏠 11. Дом на мальдивах - 50.000.000£</b>
    <b>🏠 12. Технологичный небосрёб - 75.000.000£</b>
    <b>🏠 13. Собственный остров - 90.000.000£</b>
    <b>🏠 14. Дом на марсе - 120.000.000£</b>
    <b>🏠 15. Остров на марсе - 150.000.000£</b>
    <b>🏠 16. Свой марс - 200.000.000£</b>
    
    <code>🛒 Для покупки дома введите "Купить дом [номер]"</code>
    ''', parse_mode='html')
        #######################################################КЕЙСЫ############################################################
        ...
        if message.text.lower() in ['Продать телефон', "продать телефон"]:
            ...
            if phone > 0:
                if phone == 1:
                    ...
                    await bot.send_message(message.chat.id, f'{name}, <code>вы успешно продали телефон за {price3}£</code> ',
                                           parse_mode='html')
                    cursor.execute(f'UPDATE users SET balance = {balance + price2}  WHERE user_id = "{user_id}"')
        ...
        if message.text.lower() in ['Телефоны', "телефоны"]:
            ...
            photo = open('Apple_Hero_CHina_Store.jpg', 'rb')
            await bot.send_photo(message.chat.id, photo, f'''
    {name}, <code>доступные телефоны:</code>
    <b>📱 1. Nokia 3310 - 100.000£
    📱 2. ASUS ZenFone 4 - 1.000.000£
    📱 3. BQ Aquaris X - 2.000.000£
    📱 4. Huawei P40 - 3.000.000£
    📱 5. Samsung Galaxy S21 Ultra - 6.000.000£
    📱 6. Xiaomi Mi 11 - 10.000.000£
    📱 7. iPhone 11 Pro - 15.000.000£
    📱 8. iPhone 12 Pro Max - 20.000.000£
    📱 9. Blackberry - 40.000.000£</b>
    
    🛒 <code>Для покупки телефона введите "Купить телефон [номер]</code>"''', parse_mode='html')
        #####################################################МАШИНЫ#############################################################
        ...
        if message.text.lower() in ['Машины', "машины"]:
            ...
            photo = open('dizayn-avtosalona-lexus-03.jpg', 'rb')
            await bot.send_photo(message.chat.id, photo, f'''{name}, <code>доступные машины:</code>
    <b>🚗 1. Самокат - 10.000£
    🚗 2. Велосипед - 25.000£
    🚗 3. Гироскутер - 50.000£
    🚗 4. Сегвей - 100.000£
    ...
    🚗 6. Мотоцикл - 200.000£
    🚗 7. ВАЗ 2109 - 350.000£
    🚗 8. Квадроцикл - 500.000£
    🚗 9. Багги - 800.000£
    🚗 10. Вездеход - 1.000.000£
    🚗 11. Лада Xray - 1.500.000£
    🚗 12. Audi Q7 - 2.000.000£
    🚗 13. BMW X6 - 3.000.000£
    🚗 14. Toyota FT-HS - 5.000.000£
    🚗 15. BMW Z4 M - 10.000.000£
    🚗 16. Subaru WRX STI - 40.000.000£
    🚗 17. Lamborghini Veneno - 50.000.000£
    🚗 18. Tesla Roadster - 70.000.000£
    🚗 19. Yamaha YZF R6 - 100.000.000£
    🚗 20. Bugatti Chiron - 200.000.000£
    🚗 21. Thrust SSC - 300.000.000£
    🚗 22. Ferrari LaFerrari - 500.000.000£
    🚗 23. Koenigsegg Regear - 1.000.000.000£
    🚗 24. Tesla Semi - 1.500.000.000£
    🚗 25. Venom GT - 2.000.000.000£
    🚗 26. Rolls-Royce - 2.500.000.000£</b>
    
    🛒 <code>Для покупки машины введите "Купить машину [номер]</code>"''', parse_mode='html')
    ...
    ➡️ Максимальный уровень 🏆'''
            ...
            await bot.send_message(message.chat.id, f'''
    {name}, <code>это ваш профиль шахты:</code>
    <b>🏆 Опыт:</b> {expe2}
    <b>⚡️ Энергия:</b> {energy}
    {lvl}''', parse_mode='html')
    ...
    Используйте команду "Моя шахта", вы сможете просмотреть ваш опыт, сколько не хватает до следующего уровня, а также какая следующая стадия.''',
        ...
        if message.text.startswith("Продать лён"):
            ...
            if quantity <= linen:
                ...
                cursor.execute(f'UPDATE users SET balance = {balance + price}  WHERE user_id = "{user_id}"')
                connect.commit()
        if message.text.lower() == 'собрать пшеницу':
            name = message.from_user.get_mention(as_html=True)
            user_id = message.from_user.id
        ...
        if message.text.lower() == 'собрать картошку':
            name = message.from_user.get_mention(as_html=True)
            user_id = message.from_user.id
            ...
            if energy >= 1:
                photo = open('1647851188_4-kartinkin-net-p-kartinki-kartofelya-4.jpg', 'rb')
                await bot.send_photo(message.chat.id, photo,  f'{name}, +{rx} <code>картофана🥔.</code>\n💡 Энергия: {energy2}, опыт: {expe3}',
                                       parse_mode='html')
        ...
        if message.text.lower() == 'ферма':
            ...
            photo = open('1678286031_bogatyr-club-p-krasivaya-ferma-foni-krasivo-7.jpg', 'rb')
            await bot.send_photo(message.chat.id, photo, f'''
{name}, <b>это ферма. Здесь вы сможете добыть ресурсы для дальнейшей продажи. На ферме можно добыть - пшеницу🌾 и картошку🥔. Чтобы копать вам понадобиться энергия.
➖➖➖➖➖➖➖➖
➖➖➖➖➖➖➖➖
👨‍🌾 Как начать работать и добывать ресурсы?
Используйте команды «собрать пшеницу», «собрать картошку».
➖➖➖➖➖➖➖➖
➖➖➖➖➖➖➖➖
👛 Как продавать ресурсы?
Используйте команды «продать пшеницу», «продать картошку».</b>
''', parse_mode='html')
        ...
        if message.text.lower() in ['Энергия', "энергия", "енергия", "Енергия"]:
            ...
            photo = open('03fbc3362868fd3482c0d3cdea5419cc.png', 'rb') 
            await bot.send_photo(message.chat.id, photo, f'{name}, <code>на данный момент у тебя</code> {energy} ⚡️', parse_mode='html')
       ###########################################АДМИН############################################
        if message.text.lower() in ["адмменю", "Адмм","Адмменю","менюадм", "адмм", "Менюадм"]:
            help = InlineKeyboardMarkup(row_width=2)
            admin = InlineKeyboardButton(text='💡 Админ-команды', callback_data='admin')
            help.add(admin)
            name1 = message.from_user.get_mention(as_html=True)
            photo = open('1573725782_5.jpg', 'rb')
            await bot.send_photo(message.chat.id, photo,
        ...
        if message.text.lower() in ["помощь", "Помощь"]:
            ...
            name1 = message.from_user.get_mention(as_html=True)
            photo = open('IMG_20230705_184335_765.jpg', 'rb')
            await bot.send_photo(message.chat.id,photo,
                ...
                if balance >= summ:
                    if summ > 0:
                        if int(rx) in range(0, 9):
                            ...
                            c2 = round(c)
                            c2 = '{:,}'.format(c2)
                            photo = open('slots.jpg', 'rb')
                            await bot.send_photo(message.chat.id, photo, f'[🤵️]Игрок: {name1}\n[🕹️] Проигрыш: {c2}$ [x0] {rloser}',
                                                   parse_mode='html')
                            cursor.execute(f'UPDATE users SET balance = {balance - summ} WHERE user_id = "{user_id}"')
                            cursor.execute(f'UPDATE bot SET last_stavka=? WHERE chat_id=?', (time.time(), chat_id,))
                            connect.commit()
                        ...
                        if int(rx) in range(55, 64):
                            ...
                            photo = open('casino-online.jpg', 'rb')
                            await bot.send_photo(message.chat.id,  f'[🤵️] Игрок: {name1}\n[🕹️] Деньги остаются у вас: {c2}$ [1.00X] {rwin}',
                                                   parse_mode='html')
                            cursor.execute(f'UPDATE bot SET last_stavka=? WHERE chat_id=?', (time.time(), chat_id,))
                            connect.commit()
                            return
...
💎 | Вся информация в разделе доната, пишите "донат"
